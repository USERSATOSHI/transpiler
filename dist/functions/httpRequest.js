...
exports.$httpRequest = {
    ...
    description: "creates a http request to the given url with the given method and returns the response",
    ...
    code: (data, scope) => {
        ...
        if (exports.$httpRequest.brackets) {
            if (!data.total.startsWith(exports.$httpRequest.name + "[") &&
