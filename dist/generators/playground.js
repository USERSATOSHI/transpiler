...
<head>
    ...
    <title>Transpiler PlayGround</title>
...
async function homeGen() {
    (0, fs_1.mkdirSync)("./docs/playground/", { recursive: true });
    await (0, promises_1.writeFile)("./docs/playground/index.html", html);
    await (0, promises_1.writeFile)("./docs/playground/playground.css", css);
    await (0, promises_1.writeFile)("./docs/playground/playground.js", js);
}
exports.homeGen = homeGen;
homeGen();
