...
<html class="light">
  <head>
    ...
    <title>Transpiler HomePage</title>
...
async function homeGen() {
    (0, fs_1.mkdirSync)("./docs/home/", { recursive: true });
    await (0, promises_1.writeFile)("./docs/home/index.html", homehtml);
    await (0, promises_1.writeFile)("./docs/home/home.css", homecss);
    await (0, promises_1.writeFile)("./docs/home/home.js", homejs);
}
